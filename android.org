...
An activity is visible after it's been started and before it's been stopped. When being created or destroyed, or killed (triggering a restart), it's not visible.
