...
A [[http://developer.android.com/guide/topics/fundamentals/tasks-and-back-stack.html][task]] is a set of related activities, which don't have to be part of the same application.
