...
** Talleres
*** TICs (siempre software libre)                                 :formacion:
...
*** Startups
- Método LEAN
- Organización holacrática
- Globalización de proveedores
- Tests A/B, multivariantes
- SEO, SEM
...
** Gestión holacrática
- Eliminación de jerarquías innecesarias en la gestión pública.
- Aplicación de una organización holacrática: autogestión de grupos de trabajo, toma de decisiones eficiente, respuesta rápida.
