...
shipyard run --name samalba/docker-registry --cpus 0.1 --memory 1024 --type service --hostname docker --domain acm-sl.org --label service --pull --port tcp/5000:5000 --vol /home/chous/docker-registry:/tmp/registry --env STORAGE_PATH=/registry
