...
Password: xxxx
** Run registry:
shipyard run --name docker --cpus 0.3 --memory 128 --type service --hostname docker --domain acm-sl.org --label service --pull --port tcp/5000:5000 -v /home/chous/docker-registry:/registry --env 'STORAGE_PATH=/registry'
** Run jenkins:
...
shipyard run --name samalba/docker-registry --cpus 0.1 --memory 1024 --type service --hostname docker --domain acm-sl.org --label service --pull --port tcp/5000:5000 -v /home/chous/docker-registry:/registry -e STORAGE_PATH=/registry
